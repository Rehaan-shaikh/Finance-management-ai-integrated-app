      ...
      await db.$transaction(async (tx) => {
        ...
        await tx.transaction.create({
          data: {
            ...
            isRecurring: false, 
            //if it isnt recurring then this new trans would again be invoked ,  instead of th orignal one
          },
        });
...
// its gives monthly income, total expense ,category and total no of transactions in month so that we can provide thisw to gemini ai
